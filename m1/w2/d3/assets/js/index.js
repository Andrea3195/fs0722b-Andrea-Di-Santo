...
if(totalShoppingCart > 50){
  console.log((totalShoppingCart / 100) *20 + '$' + ' ' + 'è lo sconto applicato')
}
else{
  console.log(((totalShoppingCart + 10) / 100) *20 + '$' + ' ' + 'è lo sconto applicato')
}
...
if(c > b && c > a){
  console.log('30 è il valore più alto')
}
else if(c > b && b > a){
  console.log('20 è il valore intermedio')
}
else{
  console.log('10 è il valore più basso')
}
